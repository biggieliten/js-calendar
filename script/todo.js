...
function renderTodoCards() {
  ...
  const todoSectionCompleted = document.querySelector(
  ...
  sortedTodos.forEach((t) => {
    const todoDate = t.startAt.toLocaleDateString("sv", {
      day: "2-digit",
      month: "2-digit",
      year: "2-digit",
    });
...
function createTodoCard(todo, showDate) {
  ...
  startAt.textContent = todo.startAt.toLocaleTimeString("sv", {
    hour: "2-digit",
    minute: "2-digit",
  });
  endAt.textContent = todo.endAt.toLocaleTimeString("sv", {
    hour: "2-digit",
    minute: "2-digit",
  });
